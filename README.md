...
Functions, custom or otherwise, that can be ran throughout an application’s runtime, and before certain logic in an endpoint is hit.

- [x] Describe a Resource?

Any piece of data within a database.
